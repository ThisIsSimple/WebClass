...
<body>
    <nav class="navbar navbar-light" style="background-color: #A146E8;">
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <form id="loginForm" class="form-inline">
                        <input class="form-control mr-sm-2" type="text" id="id" name="id" placeholder="id" aria-label="id">
                        <input class="form-control mr-sm-2" type="text" id="password" name="password" placeholder="password" aria-label="password">
    ...
    <script>
        $(function() {
            $('#loginForm').submit(function(event) {
                ...
                $.post({
                    'url': 'http://localhost:8080/WebClass/login',
                    'data': {
                        id: id,
                        pwd: password
                    },
                    'success': function(data) {
                        ...
                        $('#loginModal .modal-body').html(data.id + "님, 로그인 되었습니다.");
                    }
                });
            })
        });
